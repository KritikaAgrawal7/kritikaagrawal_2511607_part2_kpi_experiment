...
The experiment demonstrated a statistically significant improvement in the primary success metric, Paid Conversion Rate. The Treatment group achieved a Paid Conversion Rate of 7.04%, compared to 3.19% for the Control group, representing an improvement of 3.85 percentage points (120.87%). A One-Tailed Two-Proportion Z-Test confirmed that this improvement was statistically significant (Z = 3.264, p-value = 0.00055).
...
The increase in Support Ticket Rate indicates that more users required customer support after experiencing the Treatment. Additionally, although the Treatment increased the number of paid conversions, the Average Revenue per Converted User decreased during the 30-day observation period. These guardrail metrics should be monitored and investigated before considering a full rollout.
